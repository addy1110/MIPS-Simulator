...
vector<bitset<8> > readFromFile(string fileName){
    vector<bitset<8>> readToVector;
    readToVector.resize(MemSize);
    ifstream in;
    string line;
    int i=0;
    in.open(fileName);
...
public:
    ...
    INSMem()
    {
     IMem = readFromFile("/Users/ADDY/ClionProjects/CA_Lab1/testbench1.txt");
    }
...
public:
    ...
    DataMem()
    {
        DMem = readFromFile("/Users/ADDY/ClionProjects/CA_Lab1/dmem.txt");
    }
